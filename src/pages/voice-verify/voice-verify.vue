<template>
	<!-- 语音验证页面 -->
	<view class="voice_verify-wrapper">
		<!-- 顶部导航条开始 -->
		...
		<!-- 顶部导航条结束 -->
		<!-- 输入框区域开始 -->
		<view class="voice_verify-bj"></view>
		<view class="voice_verify-content">
			<view class="note-desc">需要发送语音验证的手机号码为：</view>
			<view class="note-iphone">{{user_phone}}</view>
			<view class="code-area">
				<input class="uni-input code-input"
					...
					maxlength="6"
				/>
				<button class="uni-botton code-btn"
					type="primary"
					@tap="sendCode()"
					:disabled="isSend"
