<template>
	...
	<view class="uni-navbar">
		<view class="uni-navbar__content status-bar" :class="{'uni-navbar--fixed': !!fixed,'uni-navbar--shadow':!!border,'uni-navbar--border':!!border}" :style="{'background':backgroundColor}">
